  ...
  return (
    <main>
        <div className="mt-8 prose prose-slate mx-auto lg:prose-lg">
            ...
            https://openaudiomc.net/download
            </code></pre>
            ...
            <hr />
            <h2>Sync show with server</h2>
            <p>OpenAudioMc is a web-first platform, meaning that everything you give it as input has to be accessible over the internet. In this case, that means that your media sources need to come from a publicly available web-page or another supported platform This usually comes in the form of URL's you enter within your other audio related commands or API queries.</p>
            ...
            <figure>
                <img className='rounded' src="https://images.unsplash.com/photo-1556740758-90de374c12ad?ixlib=rb-1.2.1&amp;ixid=eyJhcHBfaWQiOjEyMDd9&amp;auto=format&amp;fit=crop&amp;w=1000&amp;q=80" alt="" />
                <figcaption>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classNameical Latin literature from 45 BC, making it over 2000 years old.</figcaption>
            </figure>
